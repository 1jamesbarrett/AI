...
input_file= pd.DataFrame(inputs)
###################################################################################################
# scale data and add column for intercept
input_file_scale =  preprocessing.scale(inputs)
temp_array = []

t_a = input_file_scale[:,0:2]
t_b = input_file.iloc[:,2:3]
input_file_scaled =  np.concatenate((t_a,t_b), axis=1)
...
i= 0
jb_iter  = [100, 100, 100, 100, 100, 100, 100, 100, 100, 100000]
